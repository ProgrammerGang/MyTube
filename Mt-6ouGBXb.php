...
<head>
    ...
    <title>Info to end yourself - MyTube</title>
...
<body>
  ...
  <h1>‎</h1>
    <video src="uploads/info_to_go_end_yourself~2.mp4" controls></video>
    <h2>Info to end yourself</h2>
    <nav>
        <h3>Upload Date: November 9th, 2023</h3>
        <h3>Description:</h3>
        <p></p>
        <h3>Uploader: LowTierGod</h3>
    </nav>
</body>
</html>